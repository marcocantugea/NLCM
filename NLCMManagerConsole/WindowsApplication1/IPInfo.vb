Public Class IPInfo
    ...
    Private _IPStatisticsCollection As IPStatisticsCollection

    Public Property IPStatisticsCollection As IPStatisticsCollection
        Get
            Return _IPStatisticsCollection
        End Get
        Set(value As IPStatisticsCollection)
            _IPStatisticsCollection = value
        End Set
    End Property
